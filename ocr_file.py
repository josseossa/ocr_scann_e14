...
def main(argv: list):
    parser = argparse.ArgumentParser(description='Run OCR through file')
    '''Adding config option to define the number of files to create'''
    parser.add_argument('-f', '--file',
                        type=str,
                        required=True,
                        help='file to pass through OCR')

    args = parser.parse_args()

    # Path of the Input pdf
    PDF_file = Path(f"{args.file}")
